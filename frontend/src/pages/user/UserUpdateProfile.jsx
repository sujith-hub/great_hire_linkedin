...
//     profilePhoto: user?.profile?.profilePhoto || "", // Fetch user's current image
//   });
...
//       reader.onloadend = () => setPreviewImage(reader.result); // Set the preview image
...
//                     src={previewImage}
//                     alt="Preview"
//                     className="w-20 h-20 rounded-full object-cover border flex flex-col items-center"
//                   />
//                 ) : (
...
import { USER_API_END_POINT } from "@/utils/ApiEndPoint"; // Ensure correct import
