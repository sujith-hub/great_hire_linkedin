          ...
          <div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              ...
              <p className="text-gray-600">
                ...
                {app.applicant?.address?.city}, {app.applicant?.address?.state},{" "}
          ...
          {app.applicant?.profile?.experience && (
            <div className="flex flex-col space-y-2">
              ...
              <p className="text-gray-600 flex flex-col space-y-1">
                ...
                <span>{app.applicant.profile.experience.duration} year(s)</span>
              </p>
              <p className="text-gray-600 flex flex-col space-y-1">
                <span className="font-semibold">Details:</span>{" "}
                <span>{app.applicant.profile.experience.experienceDetails}</span>
              </p>
            </div>
          )}
